...
public:
     ...
     *
        * Used for Mozhi to specify the instance URL.
     *
     * @param engine engine
    ...
    void setMozhiEngine(QString engine);
...
private:
    ...
    void buildMozhiStateMachine();
    void buildMozhiDetectStateMachine();
    ...
    static constexpr int s_mozhiTranslateLimit = 5000;
